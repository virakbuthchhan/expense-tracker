...
object PdfExportService {
    ...
    suspend fun generatePdfToStream(
        ...
        try {
            ...
            currentY += 12f
            canvas.drawText("Expense Tracker • 100% Offline & Private Financial Record", MARGIN_X, currentY, subtitlePaint)
            ...
            if (transactions.isEmpty()) {
                ...
                for (i in transactions.indices) {
                    ...
                    if (currentY + rowHeight > PAGE_HEIGHT - 50f) {
                        ...
                        canvas.drawText("Page $currentPageNumber of $totalPages • Generated by Expense Tracker Offline", PAGE_WIDTH / 2f, PAGE_HEIGHT - 20f, footerTxtPaint)
